  ...
  return (
    <div className="w-full p-0.5 pl-6 pr-6 mb-3 mt-3 lg:w-2/3 lg:m-auto lg:mb-3 lg:mt-3">
      <form onSubmit={submitHandler}>
        <input className="ms-0 rounded-l-xl border-solid border-3 w-8/10 border-gray-400 dark:border-gray-200 focus:border-violet-400 md:w-9/10" type="text" name="tareaInput" id='tareaInput' placeholder="Escribe tu nueva tarea" />
